 ...
 *
 *   <script src="https://<pages-domain>/TicketingWidgets/widgets/trpl-float.js" async></script>
 *
 * Behavior:
...
(function () {
  ...
  var CSS = [
    ...
    "font-family:'ITC Clearface','Clearface',Georgia,serif;color:#25282A;",
    ...
    "#trpl-float[data-risk=sold_out],#trpl-float[data-risk=high]{border-left-color:#B4531F}",
    "#trpl-float strong{display:block;font-family:'Dharma Gothic E','Dharma Gothic','Arial Narrow',Impact,sans-serif;",
    "text-transform:uppercase;letter-spacing:.04em;font-size:1.2rem;line-height:1.15;color:#092A4D;",
    "margin:0 1.4rem .25rem 0}",
    "#trpl-float[data-risk=high] strong,#trpl-float[data-risk=sold_out] strong{color:#B4531F}",
    ...
    "font-family:'Dharma Gothic E','Dharma Gothic','Arial Narrow',Impact,sans-serif;text-transform:uppercase;",
    "letter-spacing:.06em;font-weight:700;padding:.4em 1.2em .3em;border-radius:3px;text-decoration:none;font-size:.95rem}",
